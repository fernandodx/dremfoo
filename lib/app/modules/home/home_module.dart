...
class HomeModule extends Module {
  ...
  final List<Bind> binds = [
    ...
    Bind.lazySingleton((i) => HomeUseCase(i.get<RegisterUserRepository>(), i.get<HomeRepository>(), i.get<SharedPrefsRepository>())),

    Bind.lazySingleton((i) => RankStore(i.get<HomeUseCase>())),
    Bind.lazySingleton((i) => BottomNavigateStore()),
    Bind.lazySingleton((i) => SplashStore(i.get<LoginUseCase>())),
